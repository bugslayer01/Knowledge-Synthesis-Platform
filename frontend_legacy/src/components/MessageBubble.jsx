...
export default function MessageBubble({ message }) {
  ...
  const displayContent =
    isLongMessage && !isExpanded ? content.substring(0, 500) + "..." : content;

  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"} group`}>
      <div className={`w-full max-w-5xl ${isUser ? "order-2" : "order-1"}`}>
        <div
        ...
        >
          ...
          <div
            className={`px-4 py-3 rounded-lg shadow-sm w-full sm:max-w-3xl ${
              isUser
                  ...
                  {(() => {
                    ...
                    if (docEntries.length === 1) {
                      ...
                      if (doc.pages.length === 0) {
                        ...
                        return (
                          <span>
                            {doc.name} • Pages {sortedPages.join(", ")}
                          </span>
                        );
                      }
                    } else {
                      ...
                      return (
                        <>
                          <button
                            onClick={() =>
                              setShowCitationDropdown(!showCitationDropdown)
                            }
                          ...
                          >
                            ...
                            <svg
                              className={`w-3 h-3 transition-transform ${
                                showCitationDropdown ? "rotate-180" : ""
                              }`}
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
          ...
          <div className="flex items-center gap-2">
            ...
            {!isUser && (
              <button
                ...
                title={
                  markdownEnabled ? "Disable formatting" : "Enable formatting"
                }
              >
